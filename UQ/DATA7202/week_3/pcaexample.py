...
os.chdir('/Users/Ted/Desktop/computer_science/DATA7202/week_3')#更改路径，''里面为更改的路径
#print(os.getcwd())#显示当前路径
...
print("# components = ",ncomp, " variance explained = ", np.sum(pca.explained_variance_ratio_), " compression rate = ", 1 - (ncomp/512))  
img_to_show
