...
class Controls(tk.Frame):
    def __init__(self, master, parent):
        ...
        tk.Button(self, text="Open", command=self.open).pack(side=tk.LEFT)
    ...
    def open(self):
        ...
        if filename:
            self._parent.get_model().load_circles(filename)
            self._parent.get_view().redraw()
    #-----------------------
