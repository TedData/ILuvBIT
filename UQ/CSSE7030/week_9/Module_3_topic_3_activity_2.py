...
class DemoApp(object):
    ...
    def __init__(self, master=None):
        ...
        self._button10 = tk.Button(self._frame3, text="Button 10",bg='green')
        self._button10.pack(side=tk.LEFT,ipadx=30)
        self._button11 = tk.Button(self._frame3, text="Button 11",bg='green')
        self._button11.pack(side=tk.LEFT, padx=20)
        self._button12 = tk.Button(self._frame3, text="Button 12",bg='green')
